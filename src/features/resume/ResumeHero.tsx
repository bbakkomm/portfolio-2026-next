...
export default function ResumeHero() {
  return (
    <section className="pt-6">
      <h1 className="text-[26px] md:text-[32px] font-bold tracking-[-0.02em] leading-[1.35] text-zinc-50 m-0">
      ...
      >
        <p className="text-zinc-300 text-[14.5px] leading-[1.85] m-0 break-keep">
