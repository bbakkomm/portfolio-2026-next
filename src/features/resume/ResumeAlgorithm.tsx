...
const ResumeAlgorithm = () => {
  ...
  return (
    <section>
      ...
      <h2 className="text-[24px] font-bold tracking-[-0.018em] text-zinc-50 mb-3 mt-0">
        백준 / solved.ac
      </h2>
      ...
      <div className="my-6 py-5 border-t border-b border-zinc-800">
        <div className="flex flex-wrap items-baseline gap-4">
          <div className="flex items-baseline gap-1">
            <span className="text-[24px] font-bold text-zinc-50 tracking-[-0.015em] leading-none">308</span>
            <span className="text-[15.5px] text-zinc-300">일 연속</span>
          </div>
          <p className="flex-1 min-w-[220px] text-zinc-400 text-[15.5px] leading-[1.7] m-0 break-keep">
      ...
      <div className="mt-10">
        ...
        <p className="text-[15.5px] text-zinc-400 mt-1.5 mb-3 break-keep">
        ...
        <ul className="list-none p-0 m-0">
          {visibleContests.map((contest, i) => (
            ...
            >
              <div className="font-semibold text-[17px] text-zinc-50">{contest}</div>
            </li>
          ))}
        </ul>
        ...
        {hiddenCount > 0 && (
          <button
            ...
            className="mt-3 bg-transparent border border-zinc-700 text-zinc-300 text-[15px] px-4 py-2 rounded-full cursor-pointer transition-colors hover:border-pink-400 hover:text-pink-400"
          >
      ...
      <a
        ...
        className="mt-10 inline-flex items-center gap-2 text-[16px] text-zinc-300 border-b border-zinc-400 pb-1.5 transition-colors hover:text-pink-400 hover:border-pink-400 group"
      >
