...
> 의사결정 배경·트러블슈팅 9건·회고 전문 → [`docs/case-study-portfolio-2026.md`](./docs/case-study-portfolio-2026.md)
...
- 케이스 스터디: [`docs/case-study-portfolio-2026.md`](./docs/case-study-portfolio-2026.md)
